...
function SelectorMultiple(props: selectorMultipleProps) {
    ...
    function seleccionarTodo(){
        const seleccionar = [...props.seleccionados, ...props.noSeleccionados];
        const noSeleccionados: selectorMultipleModel[] = [];
        props.onChange(seleccionar, noSeleccionados);
    }
